...
import 'package:taoju5_b/ui/pages/product/product_detail/fragment/product_attrs_selector/finished_product_attrs_selector/finished_product_attrs_selector_bar.dart';
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Visibility(
            child: RollingCurtainProductAttrsSelectorCard(tag: tag),

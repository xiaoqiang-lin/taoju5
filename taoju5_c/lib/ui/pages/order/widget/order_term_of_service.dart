 ...
 * @LastEditTime: 2021-05-06 16:32:24
 */
import 'package:flutter/material.dart';
import 'package:taoju5_c/res/R.dart';

class OrderTermOfServiceSheet extends StatelessWidget {
  const OrderTermOfServiceSheet({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.symmetric(
          vertical: R.dimen.dp30, horizontal: R.dimen.dp20),
      ...
      child: Text(
        ...
        style: TextStyle(color: R.color.ff999999, fontSize: R.dimen.sp10),
      ),
    );
  }
}

 ...
 * @LastEditTime: 2021-08-04 15:12:35
 */
      ...
      children: [
        ...
        Expanded(
          child: ListView.builder(
              padding:
                  EdgeInsets.symmetric(vertical: 0, horizontal: R.dimen.dp20),
              shrinkWrap: true,
              itemCount:
                  controller.product.attribute.matchingSet.attributes.length,
                    ...
                    children: [
                      Container(
                          margin: EdgeInsets.only(
                              top: R.dimen.dp18, bottom: R.dimen.dp7),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              ...
                              Visibility(
                                visible:
                                    !(GetUtils.isNullOrBlank(item.message) ??
                                        true),
                                child: Container(
                      ...
                      Container(
                        height:
                            item.options.any((e) => e.price != 0) ? 150 : 132,
                        child: ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int i) {
                              ...
                              return GestureDetector(
                                onTap: () => controller.selectAdditonalProduct(
                                    item, option),
                                child: Container(

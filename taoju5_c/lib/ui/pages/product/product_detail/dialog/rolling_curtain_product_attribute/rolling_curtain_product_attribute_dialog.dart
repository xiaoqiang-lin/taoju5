 ...
 * @LastEditTime: 2021-05-24 13:51:41
 */
...
Future openRollingCurtainProductAttributeDialog(BuildContext context,
  ...
  return showDialog(
      ...
      builder: (BuildContext context) {
        return Container(
          margin: EdgeInsets.symmetric(horizontal: R.dimen.dp32),
          child: Dialog(
...
class RollingCurtainProductAttributeDialog extends StatelessWidget {
  ...
  const RollingCurtainProductAttributeDialog(
      {Key? key, required this.attribute, required this.product})
      : super(key: key);
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                alignment: Alignment.center,
                margin: EdgeInsets.only(top: R.dimen.dp8, bottom: R.dimen.dp14),
                child: Text(
                  "不足1㎡按1㎡计算",
                  style: TextStyle(
              ...
              Container(
                margin:
                    EdgeInsets.only(top: R.dimen.dp18, bottom: R.dimen.dp15),
                child: Row(
                  children: [
                    Container(
                    ...
                    Expanded(
                      child: SizedTextField(
                        ...
                        shakeController:
                            attribute.measureData.size.heightShakeController,
                ...
                children: [
                  ...
                  Expanded(
                    child: SizedTextField(
                      ...
                      textAlign: TextAlign.start,
                      initialValue:
                          attribute.measureData.size.width?.toStringAsFixed(2),
                      onChanged: (String val) {
                ...
                child: Text.rich(TextSpan(
                    ...
                    children: [
                      TextSpan(
                          ...
                          style: TextStyle(
                              fontSize: R.dimen.sp15, color: R.color.ffff5005))
                    ])),
              ),
              Row(

...
class XExpansionPanel extends StatefulWidget {
  /// Creates a single-line [ListTile] with a trailing button that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const XExpansionPanel({
    Key key,
    this.leading,
    @required this.title,
  ...
  @override
  _XExpansionPanelState createState() => _XExpansionPanelState();
}

class _XExpansionPanelState extends State<XExpansionPanel>
